...
if (!isset($id) or empty($id)){
  ...
  $query="SELECT * from news WHERE ".$SQLshow." id=".$id."";
  ...
  <div id="main">
      ...
      <div id="text">
         ...
         <div class="text_col_right">
            ...
            <?php
            $query_related="SELECT * FROM news_items WHERE id_news=".$id." order by id_item_type ASC";
            ...
            <div class="box">
              ...
              <?php
              $query="SELECT id,header FROM articles WHERE show_item=1 AND pub_date<=NOW() AND pub_date<=NOW() AND (expire_date>=NOW() OR expire_date='0000-00-00 00:00:00') order by date_time DESC  LIMIT 8";
              //echo $query; 
              if ($con->GetQueryNum($query)>0){
                  echo '<ul>';
                  $result = $con->SelectQuery($query);
