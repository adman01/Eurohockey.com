...
$strSeason=($intSeason-1)."-".$intSeason;
  ...
  if (!empty($StrLeagueName)){
    $boolLeague=true;
    $strHeader="Statistics ".$StrLeagueName." ".$strSeason;
    $strHeaderDescription="Statistics for league ".$StrLeagueName." ".$strSeason;
    $strHeaderKeywords=HeaderKeywords.",statistics,".$StrLeagueName.",".$strSeason;
  }else{
    $boolLeague=false;
  ...
  <div id="main">
      ...
      <div id="text">
         ...
         <?php
          ...
          <div id="navigation">
            <div class="toleft">
                ...
                <div class="corner_nav_box"><?php echo '<a href="/league/'.get_url_text($StrLeagueName,$id).'?season='.$intSeason.'" title="'.$StrLeagueName.'">'.$StrLeagueName.'</a>'; ?></div>
            ...
            <span class="link"><?php echo '<a href="/stats/league-all-time/'.get_url_text($StrLeagueName,$id).'" title="Show all-time stats for league '.$StrLeagueName.'">show all time stats</a>'; ?></span>   
            </div>
         </div>       
           ...
           <div class="box normal" id="stats_search_form">
              ...
              <b>Nationality:</b>
                <select name="nationality" class="nationality">
                 ...
                 //seasons
                $query="SELECT nationality from stats INNER JOIN players ON stats.id_player=players.id WHERE id_league=".$id." AND id_season=".$intSeason." AND nationality<>'' AND id_stats_type=1 AND id_season_type=".$intType." GROUP BY  nationality ORDER BY nationality ASC";
                $intCount=$con->GetQueryNum($query);
                if ($intCount>0){
                  $result = $con->SelectQuery($query);
                  while($write = $result->fetch_array()){
         ...
         <?
          ...
          $query="SELECT
           (SELECT id_club FROM stats s WHERE s.id_league=".$id." AND s.id_season=".$intSeason." AND s.id_season_type=".$intType." AND s.id_player=stats.id_player ORDER by s.id DESC LIMIT 1) as id_club,
           ...
           FROM stats INNER JOIN players ON stats.id_player=players.id WHERE id_league=".$id." AND id_season=".$intSeason." AND id_stats_type=1 ".$sqlWhere." GROUP BY id_player HAVING id_club  
           ORDER BY ".$strOrder;
            //echo $query; 
              if ($con->GetQueryNum($query)>0){
                  
                  $strVariables.='season='.$intSeason.'&amp;list_number='.$_GET['list_number'].'&amp;';
                  echo '<table class="basic stats_main">';
                  echo '
                  <thead>
                  <tr>
                    <th class="" valign="top">#</th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=1&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by player name">Player name</a></th>
                    ';
                    if ($intPosition<>1){
                    //players
                    echo'
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=2&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by position">Pos</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=3&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by team">Team</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=4&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by games">GP</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=5&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by goals">G</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=6&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by assits">A</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=7&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by points">P</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=8&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by penalty minutes">PIM</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=9&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by plus minus">+/-</a></th>
                    ';
                    }else{
                    //goalies
                    echo'
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=3&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by team">Team</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=4&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by games">GP</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=6&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by minutes">MIN</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=8&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by AVG">AVG</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=9&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by PER">PER</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=10&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by shotouts">SO</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=11&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by goals">G</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=12&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by assits">A</a></th>
                    <th class="" valign="top"><a href="/stats/league/'.$intSeason.'/'.get_url_text($StrLeagueName,$id).'?is_order=1&amp;order=7&amp;dir='.$intOrderDirChange.'&amp;'.$strVariables.'" title="Sort by penalty minutes">PIM</a></th>
                    ';
                    }
                  echo '
                  </tr>
