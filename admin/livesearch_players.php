...
if (strlen($q) > 0)
{
	$query="SELECT name,surname,nationality,id,birth_date FROM players WHERE nationality LIKE '%".$q."%'  or CONCAT_WS(\" \",name,surname) LIKE '%".$q."%' ORDER BY surname,name,nationality ";
